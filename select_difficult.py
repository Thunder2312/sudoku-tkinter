...
class SelectDifficult(tk.Frame):
    def __init__(self, parent):
        ...
        images = [['Images/easy_face.png', (250, 250), 'easy_mode_image'],
                  ['Images/easy_face_cursor_on.png',
                      (250, 250), 'easy_mode_cursor_on_image'],
                  ['Images/easy_face_pressed.png',
                      (250, 250), 'easy_mode_pressed_image'],
                  ['Images/medium_face.png', (250, 250), 'medium_mode_image'],
                  ['Images/medium_face_cursor_on.png',
                      (250, 250), 'medium_mode_cursor_on_image'],
                  ['Images/medium_face_pressed.png',
                      (250, 250), 'medium_mode_pressed_image'],
                  ['Images/hard_face.png', (250, 250), 'hard_mode_image'],
                  ['Images/hard_face_cursor_on.png',
                      (250, 250), 'hard_mode_cursor_on_image'],
                  ['Images/hard_face_pressed.png',
                      (250, 250), 'hard_mode_pressed_image'],
