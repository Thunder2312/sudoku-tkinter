...
class TitleBar(tk.Frame):
    ...
    def __init__(self, parent, master):
        ...
        self.parent = parent
        self.master = master
        self.font = Font(family='Small Font', size=10)
    ...
    # List of all the images used in this widget, 'image route', 'size', atributte name'
        ...
        self.minimize_circle = tk.Label(self, image=self.minimize_off_image, bg=self.bg_color, height=25)
        self.minimize_circle.grid(row=0, column=1, sticky='NSEW')
        bind_events_for_widget(self.minimize_circle, self.functions, 'minimize')
